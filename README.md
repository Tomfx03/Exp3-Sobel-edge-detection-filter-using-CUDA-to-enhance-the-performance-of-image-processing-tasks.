...
<h3>ENTER YOUR NAME: TOM FRANCIES XAVIOUR L</h3>
<h3>ENTER YOUR REGISTER NO: 212223110060</h3>
<h3>EX. NO: 3</h3>
<h3>DATE: 17-08-20206</h3>
...
int main() {
    // Read input image
    Mat image = imread("/content/kitten.jpg", IMREAD_GRAYSCALE);
...
## OUTPUT:
<img width="640" height="427" alt="kitten" src="https://github.com/user-attachments/assets/2698ceb0-8de9-4027-92b9-a6fe1f63e3d2" />

<img width="515" height="373" alt="image" src="https://github.com/user-attachments/assets/b683b1fd-57ea-4256-9569-95a706a456b9" />


## RESULT:
Thus the program has been executed by using CUDA to perform 2D Sobel edge detection on an image using parallel GPU computing and analyze its execution time.
